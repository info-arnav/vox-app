...
import { useChatRuntime } from '../../features/chat/state/ChatRuntimeContext'
...
export default function ToastLayer() {
  const { sendError, clearSendError, chatStatus } = useChatRuntime()
  ...
  useEffect(() => {
    if (!sendError || sendError === prevSendErrorRef.current) return
